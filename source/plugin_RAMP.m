...
set([gui.l(1), gui.l(2)], 'XData', [RAMP.mit_inds(RAMP.mit_max_ind), RAMP.mit_inds(RAMP.mit_max_ind)]);
set([gui.l(3), gui.l(4)], 'XData', [RAMP.tri_inds(RAMP.tri_max_ind), RAMP.tri_inds(RAMP.tri_max_ind)]);
